...
const CATEGORY_ICONS: Record<string, any> = {
  ...
  'Drinks': <ShoppingBag size={16} />,
  'Noodles': <ShoppingBag size={16} />,
  'Coffee': <ShoppingBag size={16} />,
  'Snacks': <ShoppingBag size={16} />,
  'Stanley cup': <ShoppingBag size={16} />,
  'Earbud case': <ShoppingBag size={16} />,
  'Fan': <ShoppingBag size={16} />,
  'Speaker': <ShoppingBag size={16} />,
  'Charging cord': <ShoppingBag size={16} />,
  'Adapter': <ShoppingBag size={16} />,
  'Cable': <ShoppingBag size={16} />,
