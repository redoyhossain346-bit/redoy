  ...
  return (
    <div className="mb-0 overflow-visible [perspective:1000px]">
      <motion.div 
        ...
        className="glass-card p-8 relative overflow-hidden group flex flex-col justify-between h-[210px] border-slate-200 bg-white shadow-xl shadow-slate-200/50 [transform-style:preserve-3d]"
      >
        ...
        <div className="flex items-center justify-between relative z-10 [transform:translateZ(30px)]">
          ...
          <motion.div 
            ...
            className="p-5 rounded-[1.5rem] bg-gradient-to-br from-amber-500/5 to-amber-600/5 border border-amber-500/10 shadow-sm rotate-3 group-hover:rotate-6 transition-transform duration-500"
          >
            <Wallet className="text-amber-600" size={28} />
          </motion.div>
        </div>
        
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-slate-100 relative z-10 [transform:translateZ(20px)]">
